...
class ModelDetailWindow(QWidget):
    def __init__(self):
        super().__init__()
    ...
    def initUI(self):
        ...
        self.splider1.sliderPressed.connect(self.pressed)
        self.judgePress = False
        #实时调整
        ...
        self.splider2.sliderPressed.connect(self.pressed)
        self.judgePress = False
        # 实时调整
        ...
        self.splider3.sliderPressed.connect(self.pressed)
        self.judgePress = False
        # 实时调整
        ...
        self.splider4.sliderPressed.connect(self.pressed)
        self.judgePress = False
        # 实时调整
        ...
        self.splider5.sliderPressed.connect(self.pressed)
        self.judgePress = False
        # 实时调整
        ...
        self.splider6.sliderPressed.connect(self.pressed)
        self.judgePress = False
        # 实时调整
